...
static const char *const yytname[] =
{
  ...
  "ROMAN", "$accept", "expr", "term", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* expr: term PLUS term  */
#line 29 "roman.y"
                      { 
          int result = (yyvsp[-2].num) + (yyvsp[0].num);
...
#line 1154 "y.tab.c"
  ...
  case 4: /* term: ROMAN  */
#line 53 "roman.y"
            { (yyval.num) = romanToDecimal((yyvsp[0].str)); free((yyvsp[0].str)); }
#line 1160 "y.tab.c"
    break;
